    ...
    Min 8 chars, must include letters, number & special character (!@#$%^&*)
                ...
                <div className="space-y-2">
                  ...
                  <Select value={formData.section_id} onValueChange={(value) => handleSelectChange('section_id', value)}>
                    <SelectTrigger id="section_id" disabled={!formData.branch || sectionOptions.length === 0}>
                      <SelectValue placeholder={formData.branch ? 'SELECT YOUR SECTION' : 'SELECT BRANCH FIRST'} />
                    </SelectTrigger>
                    <SelectContent>
